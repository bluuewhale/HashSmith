...
class RobinHoodMapTest {
	...
	void isEmpty() {
		// given
		var m = new RobinHoodMap<String, Integer>();
	...
	void rehashOnLoad() {
		// gvivenm
		var m = new RobinHoodMap<Integer, Integer>(4);
	...
	@Test
	void highCollisionOnHash() {
		// given: keys with same hash
		record Fixed(int val) {
			@Override public int hashCode() { return 0x1234_5601; }
		}
		var m = new RobinHoodMap<Fixed, Integer>();
